...
${OBJECTDIR}/DigestCommunicator.o: DigestCommunicator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DigestCommunicator.o DigestCommunicator.cpp
...
${OBJECTDIR}/MaintenanceWorker.o: MaintenanceWorker.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MaintenanceWorker.o MaintenanceWorker.cpp
