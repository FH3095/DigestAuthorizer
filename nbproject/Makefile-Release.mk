...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/digestauthorizer: ssl

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/digestauthorizer: cgicc

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/digestauthorizer: fcgi

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/digestauthorizer: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/digestauthorizer ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/BasePasswordCalculator.o: BasePasswordCalculator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasePasswordCalculator.o BasePasswordCalculator.cpp

${OBJECTDIR}/BasicCommunicator.o: BasicCommunicator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasicCommunicator.o BasicCommunicator.cpp

${OBJECTDIR}/CgiEnvironmentExtended.o: CgiEnvironmentExtended.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CgiEnvironmentExtended.o CgiEnvironmentExtended.cpp

${OBJECTDIR}/DigestPasswordCalculator.o: DigestPasswordCalculator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DigestPasswordCalculator.o DigestPasswordCalculator.cpp

${OBJECTDIR}/FCgiIO.o: FCgiIO.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FCgiIO.o FCgiIO.cpp

${OBJECTDIR}/MainHandler.o: MainHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MainHandler.o MainHandler.cpp
